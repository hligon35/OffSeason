export const brandCopy = {
  ...
  about:
    'Off Season is a media company built around shows, podcasts, and personality-driven storytelling. We cover sports and culture like a group chat: fast, loud, and opinionated — with just enough structure to keep it clean.',
} as const
